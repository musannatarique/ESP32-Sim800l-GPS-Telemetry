...
### 1. Hardware Assembly
Upload the `diagram.png`  to view complete loop paths. Make sure the 1000µF capacitor sits physically close to the SIM800L power input pins to eliminate voltage dips when transmission flags trip.
